...
class CereModule(private val context: Context) {
     ...
     */
    fun init(appId: String, integrationPartnerUserId: String, token: String = "", externalUserId: String = "") {
        val env = BuildConfig.environment
        this.appId = appId
        this.externalUserId = externalUserId
        this.integrationPartnerUserId = integrationPartnerUserId
        this.token = token
        val url = "${baseUrl}?appId=${appId}&integrationPartnerUserId=${integrationPartnerUserId}&platform=android&version=${version}&env=${env}&token=${token}&externalUserId=${externalUserId}"
